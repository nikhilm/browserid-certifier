...
var conf = module.exports = convict({
  jid: {
    doc: "The JID of the component",
    format: 'string = "persona.example.com"',
    env: 'COMPONENT_JID'
  },
  password: {
    doc: "The component shared secret.",
    format: 'string = "browserid"',
    env: 'COMPONENT_PASSWORD'
  },
  host: {
    doc: "The ip address of the XMPP server.",
  ...
  port: {
    doc: "The port the XMPP server listens on for component connections.",
    format: 'integer{0,65535} = 5374',
    env: 'PORT'
  },
  pub_key_path: {
